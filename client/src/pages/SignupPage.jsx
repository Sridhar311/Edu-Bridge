        ...
        <div className="container mx-auto px-4 max-w-md w-full">
          ...
          >
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              ...
              />
              <motion.div
                className="absolute bottom-20 right-10 w-72 h-72 bg-accent-200 rounded-full mix-blend-multiply filter blur-xl opacity-30"
                animate={{
                  scale: [1, 1.3, 1],
                  x: [0, -50, 0],
                }}
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                >
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="mt-1 mr-2 w-4 h-4 text-primary-600 rounded focus:ring-primary-500"
                  />
